 ...
 * 
 * @see <a href="http://sumo.dlr.de/wiki/Simulation/Traffic_Lights">SUMO
 *      documentation</a>
 * @see <a href=
 *      "http://sumo.dlr.de/wiki/TraCI/Traffic_Lights_Value_Retrieval">TraCI
 *      documentation</a>
...
public class TrafficLight
	...
	TrafficLight(
		...
		csqvar_ChangePhaseIndex = new ChangeObjectVarQuery.ChangeIntegerQ(dis, dos,
				...
				, id, sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.TL_PHASE_INDEX);

		csqvar_ChangeProgram = new ChangeObjectVarQuery.ChangeStringQ(dis, dos,
				sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_SET_TL_VARIABLE

				, id, sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.TL_PROGRAM);

		csqvar_ChangePhaseDuration = new ChangeObjectVarQuery.ChangeIntegerQ(dis, dos,
				sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_SET_TL_VARIABLE

				, id, sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.TL_PHASE_DURATION);

		csqvar_ChangeCompleteProgramDefinition = new ChangeCompleteProgramQuery(dis, dos,
				sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.CMD_SET_TL_VARIABLE

				, id, sim.traci4j.src.java.it.polito.appeal.traci.protocol.Constants.TL_COMPLETE_PROGRAM_RYG);
	...
	/**
	 * @return the instance of {@link ReadControlledLinksQuery} relative to this
	 *         query.
	 */
	...
	/**
	 * @return the instance of {@link ReadObjectVarQuery.IntegerQ} relative to this
	 *         query.
	 */
	...
	/**
	 * @return the instance of {@link ReadObjectVarQuery.StringQ} relative to this
	 *         query.
	 */
	...
	/**
	 * @return the instance of {@link ReadCompleteDefinitionQuery} relative to this
	 *         query.
	 */
	...
	/**
	 * @return the instance of {@link ChangeLightsStateQuery} relative to this
	 *         query.
	 */
	 ...
	 * 
	 * This setter method is equivalent to
	 * queryChangeLightsState().setValue(value).run().
	 */
	...
	/**
	 * @return the instance of {@link ChangeObjectVarQuery.ChangeIntegerQ} relative
	 *         to this query.
	 */
	...
	/**
	 * Execute an instance of ChangeObjectVarQuery.ChangeIntegerQ set to the given
	 * value.
	 * 
	 * This setter method is equivalent to
	 * queryChangePhaseIndex().setValue(value).run().
	 */
	...
	/**
	 * @return the instance of {@link ChangeObjectVarQuery.ChangeStringQ} relative
	 *         to this query.
	 */
	...
	/**
	 * Execute an instance of ChangeObjectVarQuery.ChangeStringQ set to the given
	 * value.
	 * 
	 * This setter method is equivalent to
	 * queryChangeProgram().setValue(value).run().
	 */
	 ...
	 * 
	 * This setter method is equivalent to
	 * queryChangePhaseDuration().setValue(value).run().
	 */
	...
	/**
	 * @return the instance of {@link ChangeCompleteProgramQuery} relative to this
	 *         query.
	 */
	 ...
	 * 
	 * This setter method is equivalent to
	 * queryChangeCompleteProgramDefinition().setValue(value).run().
	 */
